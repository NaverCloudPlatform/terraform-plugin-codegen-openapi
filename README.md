...
You install a copy of the binary manually from the [releases](https://github.com/NaverCloudPlatform/terraform-plugin-codegen-openapi/releases) tab, or install via the Go toolchain:

```shell-session
go install github.com/NaverCloudPlatform/terraform-plugin-codegen-openapi/cmd/tfplugingen-openapi@latest
```
