...
func buildSchemaProxy(proxy *base.SchemaProxy) (*base.Schema, *SchemaError) {
	...
	// See: https://github.com/NaverCloudPlatform/terraform-plugin-codegen-openapi/issues/56
...
func retrieveType(schema *base.Schema) (string, *SchemaError) {
	...
	case 0:
		...
		// https://github.com/NaverCloudPlatform/terraform-plugin-codegen-openapi/issues/79
